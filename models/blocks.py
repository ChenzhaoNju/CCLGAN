...
class AdaptiveInstanceNorm2d(nn.Module):
    ...
    def forward(self, x): #x: 4,79,1024
        ...
        #out = F.batch_norm(x_reshaped, running_mean, running_var, True, self.momentum, self.eps)
        # out: 1,4096,79
...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=64, patch_size=8, in_chans=256, embed_dim=768, norm_layer=None,STEM=False):
        super().__init__()
